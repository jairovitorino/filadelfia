...
<form name="formulario">
  <table width="67%" border="0" align="center">
	...
	$mysql = new Mysql();
	$mysql->conectar();
	$sql = mysql_query("SELECT * FROM membros WHERE fk_saida = 6 AND pk_membro = ".$pk_membro." ORDER BY nm_membro");
  ...
  <table width="67%" border="0" align="center">
    ...
    <tr> 
      <td class="labelCentro"><input name="membro" type="button" onClick="tpl('classes/interface.php?abrirMembroCadastro=abrirMembroCadastro')" value="Membro">
