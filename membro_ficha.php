...
<form name="formulario">
  <table width="80%" border="0" align="center">
    ...
    <tr> 
      <td colspan="5" class="labelCentro">Foto</td>
    </tr>
    <tr> 
      <td width="10%" class="labelEsquerda">NOME:</td>
      <td width="17%" class="labelEsquerda"><?php echo $nm_membro;?></td>
      <td width="6%" class="labelDireita"> TEL:</td>
    ...
    <tr> 
      ...
      <td width="26%" class="labelDireita">CEP:</td>
      <td width="41%" class="labelEsquerda"><?php echo $nu_cep;?></td>
    </tr>
  </table>
  <table width="80%" border="0" align="center">
    <tr> 
  ...
  <table width="80%" border="0" align="center">	
	<tr> 
      <td colspan="4" class="labelCentro"><input name="aptidao" type="button" id="volta" onClick="tpl('classes/interface.php?abrirAcaoMembro=abrirAcaoMembro&pk_membro=<?php echo $id;?>&nm_membro=<?php echo $nm_membro;?>&nu_tel_casa=<?php echo $nu_tel_casa;?>&te_foto=<?php echo $te_foto;?>')" value="Aptid&otilde;es">
        <input name="imprime" type="button" id="imprime" onClick="tpl('classes/interface.php?abrirFichaPdf=abrirFichaPdf&pk_membro=<?php echo $pk_membro;?>')" value="Imprimir PDF"> 
