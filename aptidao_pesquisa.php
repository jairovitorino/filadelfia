...
<form name="formulario">
  <table width="67%" border="0" align="center">
    ...
    <tr> 
      <td colspan="2" class="labelCentro"><input name="lista" type="button" id="lista" value="   Listar    "></td>
    </tr>
      <tr> 
  <td colspan="2" class="labelCentro"><input type="button" name="cadastro"  id="cadastro" value="Cadastrar" onClick="tpl('classes/interface.php?abrirMembroAptidao=abrirMembroAptidao')">
        </td>
    </tr>
    <tr> 
