...
<form name="formulario">
  <table width="80%" border="0" align="center">
    ...
    <tr> 
      <td colspan="2" class="labelCentro">INDICADORES</td>
    </tr>
    <tr> 
	...
	$medio = mysql_query("SELECT * FROM membros, instrucao WHERE membros.fk_instrucao = instrucao.pk_instrucao AND fk_instrucao = 3  ");
	$row_medio = mysql_num_rows($medio);
	for ($n = 0; $n < $row_mediorow_medio; $n++){
	}
	$superior = mysql_query("SELECT * FROM membros, instrucao WHERE membros.fk_instrucao = instrucao.pk_instrucao AND fk_instrucao = 4  ");
	$row_super = mysql_num_rows($separados);
	for ($o = 0; $o < $row_super; $o++){
	}
	$pos = mysql_query("SELECT * FROM membros, instrucao WHERE membros.fk_instrucao = instrucao.pk_instrucao AND fk_instrucao = 5  ");
	$row_pos = mysql_num_rows($pos);
	for ($p = 0; $p < $row_pos; $p++){
	}
   ...
   <tr>
	...
	<tr>
     ...
     <tr>
      ...
      <td class="labelEsquerda"><img src="img/barra.jpg" width="<?php echo $m;?>" height="10">&nbsp;<?php echo $m;?></td>
    </tr>
   <tr>
      <td class="labelEsquerda">Medio</td>
      <td class="labelEsquerda"><img src="img/barra.jpg" width="<?php echo $n;?>" height="10">&nbsp;<?php echo $n;?></td>
    </tr>
 	<tr>
      <td class="labelEsquerda">Superior</td>
      <td class="labelEsquerda"><img src="img/barra.jpg" width="<?php echo $o;?>" height="10">&nbsp;<?php echo $o;?></td>
    </tr>
		<tr>
      <td class="labelEsquerda">P&oacute;s-Gradua&ccedil;&atilde;o</td>
      <td class="labelEsquerda"><img src="img/barra.jpg" width="<?php echo $p;?>" height="10">&nbsp;<?php echo $p;?></td>
    </tr>
  </table>
